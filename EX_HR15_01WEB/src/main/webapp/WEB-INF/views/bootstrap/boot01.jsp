...
<body>
     <div class="container">
	    ...
	    <div class="row text-right">
	    	<label class="col-xs-3 col-sm-3 col-md-2 col-lg-2"></label>
	    ...
	    <!-- 검색영역 -->
	    <div class="row text-right">
	    	<form action=""  class="form-inline text-right  col-xs-7 col-sm-7 col-md-7 col-lg-7">
		   ...
		   <div class="text-center col-xs-7 col-sm-7 col-md-7 col-lg-7">
			...
			<table class="table table-striped table-bordered table-hover table-condensed">
				<thead class="bg-primary">  
					...
					<th class="text-center col-lg-2 col-md-2  col-xs-2">제목</th>
					<th class="text-center col-lg-2 col-md-2  col-xs-2">작성자</th>
					<th class="text-center col-lg-1 col-md-1  col-xs-1">작성일</th>
	...
	<div class="row col-xs-5 col-sm-5 col-md-5 col-lg-5">
	 ...
	 <div class="container">
	    ...
	    <!-- 버튼 -->
	    <div class="row text-right">
	    	<label class="col-xs-1 col-sm-2 col-md-2 col-lg-2"></label>
	        <div   class="col-xs-4 col-sm-3 col-md-3 col-lg-3">
	        	<input type="button" class="btn btn-primary btn-sm"  value="초기화" id="moveToList"/>
	        	<input type="button" class="btn btn-primary btn-sm"  value="등록" id=""/>
	        	<input type="button" class="btn btn-primary btn-sm"  value="수정" id=""/>
	        	<input type="button" class="btn btn-primary btn-sm"  value="삭제" id=""/>
	        </div>
	    </div>
	    <!--// 버튼 -->
